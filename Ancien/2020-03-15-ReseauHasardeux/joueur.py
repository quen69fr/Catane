...
class Joueur():
    ...
    def afficheSecondaire(self, ySecondaire):
        ...
        if c == BLANC:
            c = NOIR
        affiche_texte(self.nom.upper(), int(self.xSecondaire + m + LARGEUR_IMAGE_JOUEUR + (HAUTEUR_CARRE_JOUEUR_SECONDAIRE - m - LARGEUR_IMAGE_JOUEUR) / 2), int(ySecondaire + HAUTEUR_IMAGE_JOUEUR / 2 + m), None, 28, c, centrer=True)
